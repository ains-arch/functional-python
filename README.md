# Functional Python [![](https://github.com/ains-arch/functional-python/workflows/tests/badge.svg)](https://github.com/ains-arch/functional-python/actions?query=workflow%3Atests)
